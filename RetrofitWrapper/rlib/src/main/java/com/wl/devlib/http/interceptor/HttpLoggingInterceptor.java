...
public class HttpLoggingInterceptor implements Interceptor {
    ...
    public Response intercept(@NonNull Chain chain) throws IOException {
        ...
        if (!logHeaders && hasRequestBody) {
            requestBuilder.append(LINE_SEPARATOR)
                    .append(" (")
        ...
        LoggerUtils.i(requestBuilder.toString());
        ...
        try {
            ...
            LoggerUtils.e("<-- HTTP FAILED: " + e);
            throw e;
        }

        if (response.request().url().pathSegments().contains("404.html")) { // 过滤404错误页面
            LoggerUtils.e("<-- HTTP FAILED: " + response.request().url());
            return response;
        }
                ...
                if (responseBody != null) {
                    ...
                    if (!isPlaintext(buffer)) {
                        ...
                        responseBuilder.append(LINE_SEPARATOR)
                                ...
                                .append(buffer.size())
                                .append("-byte body omitted)");
                        LoggerUtils.i(responseBuilder.toString());
                        return response;
                    }
