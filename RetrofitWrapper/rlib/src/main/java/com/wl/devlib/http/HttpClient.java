...
import com.wl.devlib.http.cache.OkHttpCookieCache;
import com.wl.devlib.http.config.UrlConfig;
import com.wl.devlib.http.cookie.OkHttpCookieManager;
import com.wl.devlib.http.cookie.OkHttpCookiePersistor;
import com.wl.devlib.http.interceptor.CacheInterceptor;
import com.wl.devlib.http.interceptor.CacheInterceptorOffline;
import com.wl.devlib.http.interceptor.HeadersInterceptor;
import com.wl.devlib.http.interceptor.HttpLoggingInterceptor;
import com.wl.devlib.http.interceptor.ParamsInterceptor;
import com.wl.devlib.http.model.HttpHeaders;
import com.wl.devlib.http.model.HttpParams;
import com.wl.devlib.http.utils.CheckHelper;
import com.wl.devlib.http.utils.HttpsUtils;
...
public class HttpClient {
    ...
    private OkHttpClient.Builder generateOkHttpClient(Builder builder) {
        ...
        if (connectionPool == null) {
            connectionPool = new ConnectionPool(DEFAULT_MAXIDLE_CONNECTIONS, DEFAULT_KEEP_ALIVEDURATION,
                    TimeUnit.SECONDS);
        }
        ...
        if (cookieEnabled && cookieJar == null) {
            okhttpBuilder.cookieJar(
                    new OkHttpCookieManager(new OkHttpCookieCache(), new OkHttpCookiePersistor(context)));
        }
        if (cookieJar != null) {
