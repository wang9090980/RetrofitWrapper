package com.wl.devlib.http.converter.wrapper;

import android.support.annotation.NonNull;
import android.support.annotation.Nullable;

import com.wl.devlib.http.converter.StringConverterFactory;
...
public class StringConverterFactoryWrapper extends Converter.Factory {
    ...
    public Converter<?, RequestBody> requestBodyConverter(
            ...
            Retrofit retrofit) {
        return new StringRequestBodyConverterWrapper<>(
                original.requestBodyConverter(type, parameterAnnotations, methodAnnotations, retrofit));
    }
